...
public class ProjectListItem extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.ProjectListItem, defStyle, 0);

        text = a.getString(R.styleable.ProjectListItem_text);
        projectId = a.getString(R.styleable.ProjectListItem_projectId);
